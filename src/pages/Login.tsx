...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      showSuccess('Welcome back to ANCS Security Portal');
      navigate('/');
      setIsLoading(false);
    }, 1500);
  };
      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-4">
            <img src="/logo--ancs.png" alt="ANCS Logo" className="h-24 w-auto" />
          </div>
          <h1 className="text-2xl font-bold text-white">ANCS Security Portal</h1>
